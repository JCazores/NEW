...
/**
 * Sent to the NETWORK OWNER (owner_email on the scan),
 * not the user who ran the scan.
 * Triggered only after admin approves the email request.
 */
class VaptReportMail extends Mailable
{
